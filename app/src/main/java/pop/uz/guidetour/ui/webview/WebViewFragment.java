...
public class WebViewFragment extends Fragment {
    ...
    public void setRestrName(RestaurantsNames names) {
        this.mNames = names;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        else if (mNames == RestaurantsNames.REST2){
            mUrl = "file:///android_asset/restr2.html";
        }
        else if (mNames == RestaurantsNames.REST3){
            mUrl = "file:///android_asset/restr3.html";
        }
        else if (mNames == RestaurantsNames.REST4){
            mUrl = "file:///android_asset/restr4.html";
        }
        else if (mNames == RestaurantsNames.REST5){
            mUrl = "file:///android_asset/restr5.html";
        }
        else if (mNames == RestaurantsNames.REST6){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mContentView = view.findViewById(R.id.webView);
